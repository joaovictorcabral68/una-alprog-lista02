...
Nessa aula vimos como funciona um **fluxograma** e como podemos montar um,pois no **fluxograma** cada símbolo tem um significado, foi passado alguns exemplos de como um funciona, ele é a representação visual de um algoritmo.
